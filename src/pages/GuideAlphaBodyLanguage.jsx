  ...
  return (
    <main className="guide-article">
      ...
      <section className="ga-section">
        ...
        <p className="ga-text">
          Genuine alpha body language cannot be fully performed — it is the physical expression of a genuine internal state. However the relationship between body and mind runs in both directions. Deliberately adopting the physical characteristics of confidence — expanding your posture, slowing your movements, reducing <Link to="/dictionary">self touching</Link>, lowering your vocal pitch and pace — produces measurable changes in the hormonal and neurological states associated with genuine confidence. Starting with the physical is a legitimate route to developing the genuine internal state. The goal is not to fake confidence but to create the physical conditions in which genuine confidence can develop and express itself naturally.
        </p>
      </section>
