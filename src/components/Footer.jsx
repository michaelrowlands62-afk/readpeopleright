      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <div className="footer-socials">
            ...
            >
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
                <path d="M23.498 6.186a2.994 2.994 0 0 0-2.107-2.117C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.391.524a2.994 2.994 0 0 0-2.107 2.117A31.16 31.16 0 0 0 0 12a31.16 31.16 0 0 0 .502 5.814 2.994 2.994 0 0 0 2.107 2.117c1.886.524 9.391.524 9.391.524s7.505 0 9.391-.524a2.994 2.994 0 0 0 2.107-2.117A31.16 31.16 0 0 0 24 12a31.16 31.16 0 0 0-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
              </svg>
            </a>
          </div>
        </div>
